...
class EditUserContainer extends Component {
  componentDidMount() {
    this.props.dispatch(getUserDetail(this.props.match.params.number));
  }

  handleSubmit(data) {
    this.props.dispatch(putUserUpdate(data, this.props.match.params.number));
  }
    ...
    if (this.props.getResponDataUser || this.props.errorResponDataUser) {
      if (this.props.errorResponDataUser) {
        ...
        swal(
          "User Updated!",
          "Nama : " +
            this.props.getResponDataUser.name +
            " , Email : " +
